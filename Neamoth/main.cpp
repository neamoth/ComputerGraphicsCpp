...
glColor3f (0.0, 1.0, 0.0);
	...
	//Trapezoid
	glVertex3f(0.00f, 0.00, 0.0f);
	glVertex3f(0.10, 0.00, 0.0f);
	glVertex3f(0.10, 0.10, 0.0f);
	glVertex3f(0.00, 0.10, 0.0f);

	glColor3f(1.0, 0.01, 0.0);
	glVertex3f(0.10f, 0.20, 0.0f);
	glVertex3f(0.20, 0.20, 0.0f);
	glVertex3f(0.20, 0.10, 0.0f);
	glVertex3f(0.10, 0.10, 0.0f);
...
glClearColor (0.0, 28.0, 255.0, 247.0);
